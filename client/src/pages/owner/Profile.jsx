...
const Profile = () => {
  ...
  return (
    ...
    >
      ...
      {/* <StatsCard title="Total Venues" value={dashboard.totalVenues} />

      <StatsCard title="Bookings" value={dashboard.totalBookings} />

      <StatsCard title="Revenue" value={`₹${dashboard.totalRevenue}`} /> */}
    </DashboardLayout>
  );
};
